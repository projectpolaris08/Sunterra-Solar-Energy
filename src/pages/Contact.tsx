...
export default function Contact({ onNavigate }: ContactProps) {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-600 leading-relaxed">
              Get in touch for a free site assessment and personalized solar solution
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {contactInfo.map((info, index) => (
              <Card key={index}>
                <div className={`bg-gradient-to-br ${info.color} p-3 rounded-xl inline-block mb-4`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                Fill out the form and our solar experts will contact you within 24 hours to schedule
                your free on-site assessment. We'll evaluate your property, discuss your energy needs,
                and provide a customized solar solution.
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Submit Your Information</h3>
                    <p className="text-gray-600 text-sm">Complete the form with your details and requirements</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Schedule Assessment</h3>
                    <p className="text-gray-600 text-sm">Our team will contact you to arrange a convenient time</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Get Your Proposal</h3>
                    <p className="text-gray-600 text-sm">Receive a detailed quote and customized solar system design</p>
                  </div>
                </div>
              </div>
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <p className="text-xs text-gray-500 text-center">
                    By submitting this form, you agree to be contacted by Sunterra Solar Energy
                  </p>
                </form>
              )}
            </Card>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">We serve clients from San Jose Del Monte, Bulacan, the Rising City shaping tomorrow.</p>
          </div>
            ...
            <Card className="overflow-hidden">
              <div className="h-96 bg-gradient-to-br from-blue-200 via-blue-300 to-blue-400 flex items-center justify-center relative">
                ...
                <div className="relative z-10 text-center text-white">
                  <h3 className="text-3xl font-bold mb-2">Sunterra Solar Energy</h3>
                  <p className="text-lg">Manila, Philippines</p>
                  <p className="text-sm mt-4 max-w-md mx-auto">
                    Schedule a visit to our office to see solar products and speak with our experts
                  </p>
                </div>
              </div>
            </Card>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <Card className="max-w-4xl mx-auto text-center bg-gradient-to-br from-blue-600 to-blue-700 text-white">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Ready to Make the Switch?
            </h2>
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Join hundreds of satisfied customers saving money and the environment
            </p>
