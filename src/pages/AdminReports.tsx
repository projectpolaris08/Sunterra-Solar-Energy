...
export default function AdminReports({
  ...
  const reportTypes = [
    { name: "Sales", count: 12, color: "blue" },
    { name: "Financial", count: 8, color: "emerald" },
    { name: "Marketing", count: 15, color: "purple" },
    { name: "Operations", count: 9, color: "orange" },
    { name: "Projects", count: 11, color: "cyan" },
  ];
